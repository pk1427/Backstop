...
import {Header, Navigation, CapitalCard, PolicyChecklist, SponsorFooter} from '@/components';
                ...
                <section className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6">
                  ...
                  {backstop.executionResult ? (
                    ...
                    <div className="mt-3">
                      ...
                      <a
                        href="/opportunities"
                        className="mt-3 block w-full rounded-lg bg-zinc-900 dark:bg-zinc-100 px-4 py-2.5 text-sm font-medium text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors text-center"
                      >
                        View Opportunities
                      </a>
                    </div>
